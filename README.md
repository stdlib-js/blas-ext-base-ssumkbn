...
#### stdlib_strided_ssumkbn( N, \*X, strideX )
...
```c
float stdlib_strided_ssumkbn( const CBLAS_INT N, const float *X, const CBLAS_INT strideX );
```

#### stdlib_strided_ssumkbn_ndarray( N, \*X, strideX, offsetX )
...
```c
float stdlib_strided_ssumkbn_ndarray( const CBLAS_INT N, const float *X, const CBLAS_INT strideX, const CBLAS_INT offsetX );
```
